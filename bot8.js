...
client.on('message', msg => {
  ...
  msg.reply('وعليكم السلام ورحمه الله وبركاته :heart:')
});


client.on('message', msg => {
  if(msg.content === 'هلا')
  msg.reply(':small_orange_diamond: اهلا بك منوور :small_orange_diamond: ')
});


client.on('message', msg => {
  if(msg.content === 'باك')
  msg.reply('ولكم , احلي رجعه :rose:')
});


client.on('message', msg => {
  if(msg.content === 'برب')
  msg.reply('تيت لا تطول حب')
});

client.on('message', msg => {
  if(msg.content === 'هاي')
  msg.reply('هايات :rose:')
});


client.on('message', msg => {
  if(msg.content === 'سلام')
  msg.reply('سلام حب تشرفت بتواجد معك')
});
